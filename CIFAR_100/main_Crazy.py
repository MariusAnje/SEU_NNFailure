...
from models import resnetCrazy as resnet
import torchvision
...
def save_state(model, best_acc):
    ...
    torch.save(state, 'models/'+args.arch + '.' + args.filename +'.crazy.pth.tar')
...
if __name__=='__main__':
    ...
    parser.add_argument('--firstpretrained', action='store_true', default=False,
            help='use pretrained first layer')
    ...
    testloader = torch.utils.data.DataLoader(test_dataset, batch_size=512, shuffle=False, num_workers=4)
