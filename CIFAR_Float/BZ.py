...
if __name__=='__main__':
    ...
    #key_list = ["classifier.0.weight", "classifier.2.weight", "classifier.4.weight", "classifier.8.weight", "classifier.10.weight", "classifier.12.weight", "classifier.16.weight", "classifier.18.weight", "classifier.20.weight"]
    key_list = ["classifier.20.weight"]
