...
if __name__=='__main__':
    ...
    key_list = ["classifier.2.bias", "classifier.4.bias", "classifier.8.bias", "classifier.10.bias", "classifier.20.bias"]
    key_list = ["classifier.0.bias"]
    key_list = ["classifier.8.weight", "classifier.10.weight", "classifier.20.weight"]
    ...
    for find_key in key_list:
        ...
        randFactor = max([int(total/1500),1])
        print(randFactor)
